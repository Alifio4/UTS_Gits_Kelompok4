...
<body style="background-image: url({{ asset('assets/auth/images/bg.jpg') }}); background-position: center; background-repeat: no-repeat; background-size: cover;position: fixed;">
    <header>
        <nav class="bg-[#00000059] border-[#00000059] px-4 lg:px-6 py-2.5 dark:bg-[#00000059]">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="{{ url('/') }}" class="flex items-center">
                    <img src="{{ asset('assets/auth/images/icons/shop.png') }}" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
